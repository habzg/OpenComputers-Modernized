...
public interface Component extends Node {
     ...
     * since this is what is returned from <code>li.cil.oc.common.component.type</code>. As such it
    ...
    /**
     * Get the visibility of this li.cil.oc.common.component.
     */
    Visibility visibility();

    /**
     * Set the visibility of this li.cil.oc.common.component.
     * <br>
     ...
     * <br>
     * <em>Important</em>: this will always return <code>true</code> if the node is
    ...
    /**
     * The list of names of methods exposed by this li.cil.oc.common.component.
     * <br>
     ...
     * @return the annotation of the specified method or <code>null</code>.
     */
    Callback annotation(String method);

    /**
     * Tries to call a function with the specified name on this li.cil.oc.common.component.
     * <br>
     * The name of the method must be one of the names in {@link #methods()}.
     * The returned array may be <code>null</code> if there is no return value.
     *
     ...
     * @return the array of results, or <code>null</code> if there is no result.
     */
