 ...
 * <br>
 * A block driver is used by <code>Adapter</code> blocks to check its neighbors and
...
public interface SidedBlock {
     ...
     */
    boolean worksWith(Level Level, int x, int y, int z, Direction side);
     ...
     */
    ManagedEnvironment createEnvironment(Level Level, int x, int y, int z, Direction side);
}
