...
public interface ManagedPeripheral {
     ...
     * <br>
     * Returning <code>null</code> has the same meaning as returning an empty array,
     * that being that there are no methods - in which case you don't need this
     * interface!
     *
     * @return the array of methods provided by the environment.
     */
    String[] methods();
     ...
     */
    Object[] invoke(String method, Context context, Arguments args);
}
