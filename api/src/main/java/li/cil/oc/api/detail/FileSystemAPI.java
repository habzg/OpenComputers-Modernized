...
public interface FileSystemAPI {
     ...
     * <br>
     * If the passed type is unsupported, this will return <code>null</code>.
     *
    ...
    /**
     * Convenience overload of {@link #asManagedEnvironment(FileSystem, Label, EnvironmentHost, String, int)}
     * with the default speed of one.
     */
    ...
    /**
     * Convenience overload of {@link #asManagedEnvironment(FileSystem, String, EnvironmentHost, String, int)}
     * with the default speed of one.
     */
    @SuppressWarnings("unused")
    ManagedEnvironment asManagedEnvironment(
    ...
    /**
     * Convenience overload of {@link #asManagedEnvironment(FileSystem, Label, EnvironmentHost, String, int)}
     * without a host or access sound.
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Convenience overload of {@link #asManagedEnvironment(FileSystem, Label, EnvironmentHost, String, int)}
     * without a label, host or access sound.
     */
    @SuppressWarnings("unused")
