...
public interface Node extends Persistable {
     ...
     * <br>
     * It furthermore determines what is returned by the <code>Network</code>'s
     * <code>neighbors</code> and <code>nodes</code> functions.
     * <br>
     ...
     * <br>
     * A different matter is a {@link Component}'s <code>visibility</code>, which is
     ...
     * node.
     * <br>
     * This is a shortcut for <code>node.network.neighbors(node)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     ...
     * {@link #reachability()}.
     * <br>
     * This is a shortcut for <code>node.network.nodes(node)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this returns an empty list.
     *
     ...
     * <br>
     * This is a shortcut for <code>node.network.connect(node, other)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will throw an exception.
     *
     * @param node the node to connect to this node.
     * @throws NullPointerException if <code>network</code> is <code>null</code>.
     */
     ...
     * <br>
     * This is a shortcut for <code>node.network.disconnect(node, other)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     ...
     * <br>
     * This is a shortcut for <code>node.network.remove(node)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will do nothing.
     */
     ...
     * <br>
     * This is a shortcut for <code>node.network.sendToAddress(node, ...)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will do nothing.
     *
     ...
     * <br>
     * This is a shortcut for <code>node.network.sendToNeighbors(node, ...)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will do nothing.
     *
     ...
     * <br>
     * This is a shortcut for <code>node.network.sendToReachable(node, ...)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will do nothing.
     *
     ...
     * <br>
     * This is a shortcut for <code>node.network.sendToVisible(node, ...)</code>.
     * <br>
     * If this node is not in a network, i.e. <code>network</code> is <code>null</code>,
     * this will do nothing.
     *
