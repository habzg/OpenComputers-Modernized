 ...
 * <br>
 * This is implemented by computer case block entities. That means you can
 * use this to check for computer cases by using:
 * <pre>
 *     if (BlockEntity instanceof Case) {
 * </pre>
 * <br>
 * The only purpose is to allow identifying block entities as computer cases
