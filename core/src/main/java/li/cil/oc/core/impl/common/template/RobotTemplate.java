...
public final class RobotTemplate {
    ...
    public static Object[] assemble(Container inventory) {
        ...
        double energy = OCSettings.get().robotBaseCost + Template.complexity(inventory, hostClass) * OCSettings.get().robotComplexityCost;
    ...
    public static void register() {
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Robot (Tier 1)",
                "li.cil.oc.core.impl.common.template.RobotTemplate.selectTier1",
                "li.cil.oc.core.impl.common.template.RobotTemplate.validate",
                "li.cil.oc.core.impl.common.template.RobotTemplate.assemble",
                hostClass,
        ...
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Robot (Tier 2)",
                "li.cil.oc.core.impl.common.template.RobotTemplate.selectTier2",
                "li.cil.oc.core.impl.common.template.RobotTemplate.validate",
                "li.cil.oc.core.impl.common.template.RobotTemplate.assemble",
                hostClass,
        ...
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Robot (Tier 3)",
                "li.cil.oc.core.impl.common.template.RobotTemplate.selectTier3",
                "li.cil.oc.core.impl.common.template.RobotTemplate.validate",
                "li.cil.oc.core.impl.common.template.RobotTemplate.assemble",
                hostClass,
        ...
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Robot (Creative)",
                "li.cil.oc.core.impl.common.template.RobotTemplate.selectCreative",
                "li.cil.oc.core.impl.common.template.RobotTemplate.validate",
                "li.cil.oc.core.impl.common.template.RobotTemplate.assemble",
                hostClass,
        ...
        li.cil.oc.core.impl.common.Registrar.registerDisassemblerTemplate("Robot",
                "li.cil.oc.core.impl.common.template.RobotTemplate.selectDisassembler",
                "li.cil.oc.core.impl.common.template.RobotTemplate.disassemble");
    }
