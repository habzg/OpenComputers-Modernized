...
public final class Textures {
  ...
  public static final ResourceLocation blockCaseFrontOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/casefronton.png");
  public static final ResourceLocation blockCaseFrontError = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/casefronterror.png");
  public static final ResourceLocation blockCaseFrontActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/casefrontactivity.png");
  public static final ResourceLocation blockDiskDriveFrontActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/diskdrivefrontactivity.png");
  ...
  public static final ResourceLocation blockMicrocontrollerFrontLight = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/microcontrollerfrontlight.png");
  public static final ResourceLocation blockMicrocontrollerFrontOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/microcontrollerfronton.png");
  public static final ResourceLocation blockMicrocontrollerFrontError = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/microcontrollerfronterror.png");
  public static final ResourceLocation blockRaidFrontError = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/raid_front_error.png");
  public static final ResourceLocation blockRaidFrontActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/raid_front_activity.png");
  ...
  public static final ResourceLocation blockScreenUpIndicator = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/screen_up_indicator.png");
  public static final ResourceLocation blockRackDiskDriveActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/diskdrivemountableactivity.png");
  public static final ResourceLocation blockRackServerOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/serverfronton.png");
  public static final ResourceLocation blockRackServerError = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/serverfronterror.png");
  public static final ResourceLocation blockRackServerActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/serverfrontactivity.png");
  public static final ResourceLocation blockRackServerNetworkActivity = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/serverfrontnetworkactivity.png");
  public static final ResourceLocation blockRackTerminalServerOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/terminalserverfronton.png");
  public static final ResourceLocation blockRackTerminalServerPresence = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/terminalserverfrontpresence.png");
  public static final ResourceLocation blockGenericTop = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/generic_top.png");
  public static final ResourceLocation blockRackServer = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/rack_server.png");
  public static final ResourceLocation blockRackDiskDrive = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/rack_disk_drive.png");
  public static final ResourceLocation blockRackTerminalServer = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/rack_terminal_server.png");
  ...
  public static final ResourceLocation blockNetSplitterOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/netsplitter_on.png");
  public static final ResourceLocation blockSwitchSideOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/switch_side_on.png");
  public static final ResourceLocation blockTransposerOn = ResourceLocation.fromNamespaceAndPath(OCSettings.resourceDomain, "textures/block/overlay/transposer_on.png");
  ...
  public static void init(TextureManager tm) {
    ...
    tm.bindForSetup(blockCaseFrontOn);
    tm.bindForSetup(blockCaseFrontActivity);
    tm.bindForSetup(blockHologram);
    tm.bindForSetup(blockMicrocontrollerFrontLight);
    tm.bindForSetup(blockMicrocontrollerFrontOn);
    tm.bindForSetup(blockRackServerOn);
    tm.bindForSetup(blockRobot);
    tm.bindForSetup(blockScreenUpIndicator);
