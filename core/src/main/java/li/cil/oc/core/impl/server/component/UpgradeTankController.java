...
public abstract class UpgradeTankController {

    public static class Adapter extends AbstractManagedEnvironment implements WorldTankAnalytics, UpgradeTankControllerBase.Common {
    ...
    public static class Drone extends AbstractManagedEnvironment implements TankInventoryControl, WorldTankAnalytics, UpgradeTankControllerBase.Common {
