...
public abstract class ComponentSlot extends Slot {
    ...
    public void set(@NotNull ItemStack stack) {
        ...
        if (container instanceof PlayerInputAware) {
            ...
            if (player != null) {
                ((PlayerInputAware) container).onSetInventorySlotContents(player, getContainerSlot(), stack);
            }
        }
    }
    ...
    private Player getPlayerFromContainer() {
        if (containerMenu instanceof li.cil.oc.core.impl.common.container.Player ocPlayer) {
