...
public class Case extends li.cil.oc.core.impl.common.container.Player {
    private final li.cil.oc.core.impl.common.blockentity.Case computer;

    public Case(MenuType<?> menuType, int containerId, Inventory playerInventory, li.cil.oc.core.impl.common.blockentity.Case computer) {
        this(menuType, containerId, playerInventory, computer, computer.tier());
    }

    public Case(MenuType<?> menuType, int containerId, Inventory playerInventory, li.cil.oc.core.impl.common.blockentity.Case computer, int tier) {
