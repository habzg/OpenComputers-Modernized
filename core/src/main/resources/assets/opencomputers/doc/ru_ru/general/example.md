...
![Это рендирится напрямую.](item:opencomputers:assembler)
## Заголовок второго уровня [снова со *ссылкой*, но __немного__ длиннее](../block/adapter.md)

![Это еще одно всплывающее сообщение.](item:opencomputers:analyzer)

какой-то текст прямо над изображением для тестирования отступов
![Все цвета.](tag:opencomputers:crafting_piston)
...
![Поврежденное изображение](tag:повреждено)
...
Это тест![](item:opencomputers:cpu1) картинки в тексте kakakakalalsd 123 as

Это один тест![](item:opencomputers:cpu1)
