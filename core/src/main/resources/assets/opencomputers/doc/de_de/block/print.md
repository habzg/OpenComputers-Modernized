...
Gedruckte Blöcke sind CBMultipart-kompatibel. Dadurch können mehrere Drucke in einen einzigen Block platziert werden, solange sie nicht kollidieren oder die maximale Anzahl an Objekten in einem Block nicht überschritten wird. Dank CBMultipart können Drucke dadurch in den selben Block wie andere CBMultipart-Blöcke gestellt werden, wie Fackeln, Hebel, Kabel oder rote Legierungskabel von Project Red.
