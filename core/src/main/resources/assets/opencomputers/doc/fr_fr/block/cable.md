...
![Salade de câbles.](item:opencomputers:cable)
...
Si nécessaire, les câbles peuvent être couverts en utilisant les couvertures de CBMultipart. Gardez en tête que les [impressions 3D](print.md) sont compatible avec CBMultipart, donc il est possible d'imprimer des couvertures personnalisées, si vous le voulez.
