...
![Accès à distance.](item:opencomputers:terminal)

Le terminal à distance peut être utilisé pour contrôler à distance des [serveurs](server1.md). Pour l'utiliser, faites un clic droit en étant accroupi sur un serveur installé dans un [support de serveur](../block/rack.md) (cliquez sur le bloc du [support de serveur](../block/rack.md), en visant le [serveur](server1.md) pour y lier le terminal).
