...
![This is rendered live.](item:opencomputers:assembler)
## Smaller headline [also with *link* but this __one__ longer](../block/adapter.md)

![This is another tooltip.](item:opencomputers:analyzer)

some text directly above the item stack renderer to test spacing
![All the colors.](tag:opencomputers:crafting_piston)
...
![broken item image](tag:this is broken)
...
this is a test for an![](item:opencomputers:cpu1)an inline image kakakakalalsd 123 as

this is a test for an![](item:opencomputers:cpu1)
