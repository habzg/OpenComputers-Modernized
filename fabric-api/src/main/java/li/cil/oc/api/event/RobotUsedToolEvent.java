...
public class RobotUsedToolEvent extends RobotEvent {
     ...
     */
    public static class ComputeDamageRate extends RobotUsedToolEvent implements Cancelled {
         ...
         * <br>
         * This will be clamped to an interval of [0, 1].
         *
     ...
     */
    public static class ApplyDamageRate extends RobotUsedToolEvent implements Cancelled {
        private boolean canceled;
        ...
        @FunctionalInterface
        public interface Listener {
            void onRobotApplyDamageRate(ApplyDamageRate event);
        }

        public static final Event<Listener> EVENT = EventFactory.createArrayBacked(Listener.class, (listeners) -> (event) -> {
            for (Listener listener : listeners) {
                listener.onRobotApplyDamageRate(event);
            }
        });
    }
}
