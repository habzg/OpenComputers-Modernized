...
public final class ModRefinedStorage2 implements ModProxy {
    ...
    public void initialize() {
        li.cil.oc.core.impl.common.Registrar.registerWrenchTool("li.cil.oc.fabric.integration.refinedstorage2.EventHandlerRS2.useWrench");
        li.cil.oc.core.impl.common.Registrar.registerWrenchToolCheck("li.cil.oc.fabric.integration.refinedstorage2.EventHandlerRS2.isWrench");
