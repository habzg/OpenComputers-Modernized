package li.cil.oc.fabric.common.nanomachines.provider;
                        ...
                        for (int z = -actualRange; z <= actualRange; z++) {
                            ...
                            if (info != null && info.checkTool(player)) {
                                ...
                                InteractionResult result = AttackBlockCallback.EVENT.invoker().interact(
                                        player, world, InteractionHand.MAIN_HAND, pos, Direction.UP);
                                boolean allowed = result != InteractionResult.FAIL;
