...
import li.cil.oc.fabric.server.component.UpgradeSignInAdapter;
import li.cil.oc.fabric.server.component.UpgradeSignInRotatable;
    ...
    public static final class Provider implements EnvironmentProvider {
        ...
        public Class<?> getEnvironment(ItemStack stack) {
            if (INSTANCE.worksWith(stack)) {
                return li.cil.oc.fabric.server.component.UpgradeSign.class;
            }
            return null;
        }
    }
