...
public final class Manual implements ManualAPI {
    ...
    public static String makeRelative(String path, String base) {
        return li.cil.oc.fabric.client.gui.Manual.resolveLink(path, base);
    }
    ...
    public void openFor(Player player) {
        if (player.level().isClientSide) {
            Minecraft.getInstance().setScreen(new li.cil.oc.fabric.client.gui.Manual());
        }
    }

    @Override
    public void navigate(String path) {
        if (Minecraft.getInstance().screen instanceof li.cil.oc.fabric.client.gui.Manual) {
            ((li.cil.oc.fabric.client.gui.Manual) Minecraft.getInstance().screen).pushPage(path);
        } else {
