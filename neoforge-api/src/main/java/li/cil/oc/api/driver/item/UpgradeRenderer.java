...
public interface UpgradeRenderer {
     ...
     * <br>
     * The pose stack has not been adjusted to the mount points position, so
     ...
     * @param matrix        the pose stack to use for rendering.
     * @param buffer        the buffer source to use for rendering.
     * @param light         the packed light value.
     */
    @SuppressWarnings("unused")
    void render(com.mojang.blaze3d.vertex.PoseStack matrix, net.minecraft.client.renderer.MultiBufferSource buffer, int light, ItemStack stack, RobotRenderEvent.MountPoint mountPoint, Robot robot, float pt);
