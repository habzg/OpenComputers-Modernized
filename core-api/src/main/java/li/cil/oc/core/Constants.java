...
public final class Constants {
    ...
    public static final class BlockName {
        ...
        public static final String BeaconBasePrint = "beaconBasePrint";
        ...
        public static String Case(int tier) {
            return "case" + (tier == Tier.Four ? "Creative" : Integer.toString(tier + 1));
        }
    }
    ...
    public static final class ItemName {
        ...
        public static final String LootDisk = "lootDisk";
        ...
        public static String DroneCase(int tier) {
            return tier >= 3 ? DroneCaseCreative : "droneCase" + (tier + 1);
        }

        public static String MicrocontrollerCase(int tier) {
            return tier >= 3 ? MicrocontrollerCaseCreative : "microcontrollerCase" + (tier + 1);
        }

        public static String TabletCase(int tier) {
            return tier >= 3 ? TabletCaseCreative : "tabletCase" + (tier + 1);
        }
    }
