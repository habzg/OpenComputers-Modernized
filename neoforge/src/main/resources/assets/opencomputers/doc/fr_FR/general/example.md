...
![image de l'objet inexistante](tag:ça n'existe pas)
...
c'est un test pour une![](item:opencomputers:cpu1)une image dans une lignekakakakalalsd 123 as

c'est un test pour une![](item:opencomputers:cpu1)
