...
![Salad.](item:opencomputers:cable)
...
If necessary, cables can be covered using CBMultipart covers. Keep in mind that [3D prints](print.md) are CBMultipart compatible, so it is possible to print custom covers, if desired.
