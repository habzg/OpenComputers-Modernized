...
![Вижу красный.](item:opencomputers:redstonecard1)
...
Если у вас установлен любой из модов, которые добавляют многожильные провода, такие как Project Red или MineFactory Reloaded, или же моды, которые добавляют оборудование для передачи беспроводного сигнала карсного камня, как WE-CBE и Slimevoid's Wireless mod, становится доступной ворой уровень карты, позволяющий работать с этими системами.
