...
Распечатанные блоки совместимы с CBMultipart. Если требуется, несколько 3D моделей могут быть размещены в пределах одного блока, если они не пересекаются и количество форм не превышает лимит для одной модели. Благодаря тому, как работает CBMultipart, модели могут быть также расположены в том же блоке, что и другие совместимые с CBMultipart блоки, например: с факелами, рычагами, кабелями из красного сплава из мода Project Red и т. д.
