...
![Зелень.](item:opencomputers:cable)
...
Если необходимо, кабели могут быть накрыты оболочкой из CBMultipart. Имейте в виду, что [3D печать](print.md) совместима с CBMultipart, что делает возможным печать дополнительных` оболочек.
