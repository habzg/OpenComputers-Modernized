...
public record NeoFluidHandler(IFluidHandler delegate) implements FluidHandler {
    ...
    public static FluidStack fromNeo(net.neoforged.neoforge.fluids.FluidStack stack) {
        return new FluidStack(BuiltInRegistries.FLUID.getKey(stack.getFluid()).toString(), stack.getAmount());
    }
}
