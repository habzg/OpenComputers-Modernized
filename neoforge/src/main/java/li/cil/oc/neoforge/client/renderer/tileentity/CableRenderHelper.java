...
public final class CableRenderHelper {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Settings.resourceDomain, "textures/block/cable.png");
    private static final ResourceLocation TEXTURE_CAP = ResourceLocation.fromNamespaceAndPath(Settings.resourceDomain, "textures/block/cablecap.png");
        ...
        for (Direction side : Direction.values()) {
            ...
            if (isOCNeighbor(neighborTE)) {
                ...
                if (localTE instanceof TileMultipart localTileMP) {
                    if (!li.cil.oc.neoforge.integration.cbmultipart.MultipartNetworkBridge.canConnectFromSide(localTileMP, side)) {
                        continue;
                    }
                }
                if (neighborTE instanceof TileMultipart neighborTileMP) {
                    if (!li.cil.oc.neoforge.integration.cbmultipart.MultipartNetworkBridge.canConnectFromSide(neighborTileMP, side.getOpposite())) {
                        continue;
                    }
                }
    ...
    private static void renderBox(PoseStack poseStack, VertexConsumer c,
        ...
        // North (-Z)
        if (c instanceof ISpriteAwareVertexConsumer sac) sac.sprite(sprite);
