...
public final class DroneTemplate {
    ...
    public static Object[] assemble(Container inventory) {
        ...
        data.save(stack);
        double energy = Settings.get().droneBaseCost + Template.complexity(inventory, hostClass) * Settings.get().droneComplexityCost;
    ...
    public static void register() {
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Drone (Tier 1)",
                "li.cil.oc.neoforge.common.template.DroneTemplate.selectTier1",
                "li.cil.oc.neoforge.common.template.DroneTemplate.validate",
                "li.cil.oc.neoforge.common.template.DroneTemplate.assemble",
                hostClass, null,
        ...
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Drone (Tier 2)",
                "li.cil.oc.neoforge.common.template.DroneTemplate.selectTier2",
                "li.cil.oc.neoforge.common.template.DroneTemplate.validate",
                "li.cil.oc.neoforge.common.template.DroneTemplate.assemble",
                hostClass, null,
        ...
        li.cil.oc.core.impl.common.Registrar.registerAssemblerTemplate("Drone (Creative)",
                "li.cil.oc.neoforge.common.template.DroneTemplate.selectTierCreative",
                "li.cil.oc.neoforge.common.template.DroneTemplate.validate",
                "li.cil.oc.neoforge.common.template.DroneTemplate.assemble",
                hostClass, null,
        ...
        li.cil.oc.core.impl.common.Registrar.registerDisassemblerTemplate("Drone",
                "li.cil.oc.neoforge.common.template.DroneTemplate.selectDisassembler",
                "li.cil.oc.neoforge.common.template.DroneTemplate.disassemble");
    }
