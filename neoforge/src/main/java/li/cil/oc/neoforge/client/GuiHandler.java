...
public final class GuiHandler {
    ...
    public static void handleRegisterMenuScreens(RegisterMenuScreensEvent event) {
        reg(event, Menus.ADAPTER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Adapter((li.cil.oc.neoforge.common.container.Adapter) c, i, t));
        reg(event, Menus.ASSEMBLER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Assembler((li.cil.oc.neoforge.common.container.Assembler) c, i, t));
        reg(event, Menus.CASE, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Case((li.cil.oc.neoforge.common.container.Case) c, i, t));
        reg(event, Menus.CHARGER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Charger((li.cil.oc.neoforge.common.container.Charger) c, i, t));
        ...
        reg(event, Menus.DISASSEMBLER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Disassembler((li.cil.oc.neoforge.common.container.Disassembler) c, i, t));
        reg(event, Menus.DISK_DRIVE, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.DiskDrive((li.cil.oc.neoforge.common.container.DiskDrive) c, i, t));
        reg(event, Menus.DRONE, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Drone((li.cil.oc.neoforge.common.container.Drone) c, i, t));
        reg(event, Menus.PRINTER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Printer((li.cil.oc.neoforge.common.container.Printer) c, i, t));
        reg(event, Menus.RACK, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Rack((li.cil.oc.neoforge.common.container.Rack) c, i, t));
        reg(event, Menus.RAID, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Raid((li.cil.oc.neoforge.common.container.Raid) c, i, t));
        ...
        reg(event, Menus.SERVER, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Server((li.cil.oc.neoforge.common.container.Server) c, i, t));
        reg(event, Menus.TABLET, (AbstractContainerMenu c, Inventory i, Component t) -> new li.cil.oc.neoforge.client.gui.Tablet((li.cil.oc.neoforge.common.container.Tablet) c, i, t));
    }
    ...
    private static net.minecraft.client.gui.screens.Screen wrapScreenBuffer(
        ...
        var inner = new li.cil.oc.neoforge.client.gui.Screen(buffer, hasMouse, hasKeyboardCallback, hasPower);
    ...
    public static void openScreen(int guiType, int x, int y, int z) {
        ...
        switch (GuiType.Categories.get(guiType)) {
            case Block -> {
                ...
                if (te instanceof li.cil.oc.core.impl.common.tileentity.Screen screen && guiType == GuiType.Screen) {
                ...
                if (te instanceof li.cil.oc.core.impl.common.tileentity.Waypoint waypoint && guiType == GuiType.Waypoint) {
