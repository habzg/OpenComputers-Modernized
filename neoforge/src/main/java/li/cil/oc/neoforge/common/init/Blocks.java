...
import li.cil.oc.core.impl.common.block.NetSplitter;
...
public final class Blocks {
    ...
    public static final DeferredHolder<Block, Adapter> ADAPTER =
            BLOCKS.register(key(Constants.BlockName.Adapter), () -> new Adapter());
    public static final DeferredHolder<Block, Assembler> ASSEMBLER =
            BLOCKS.register(key(Constants.BlockName.Assembler), () -> new Assembler());
    ...
    public static final DeferredHolder<Block, Charger> CHARGER =
            BLOCKS.register(key(Constants.BlockName.Charger), () -> new Charger());
    public static final DeferredHolder<Block, Disassembler> DISASSEMBLER =
            BLOCKS.register(key(Constants.BlockName.Disassembler), () -> new Disassembler());
    ...
    public static final DeferredHolder<Block, MotionSensor> MOTION_SENSOR =
            BLOCKS.register(key(Constants.BlockName.MotionSensor), () -> new MotionSensor());
    public static final DeferredHolder<Block, PowerConverter> POWER_CONVERTER =
            BLOCKS.register(key(Constants.BlockName.PowerConverter), () -> new PowerConverter());
    public static final DeferredHolder<Block, PowerDistributor> POWER_DISTRIBUTOR =
            BLOCKS.register(key(Constants.BlockName.PowerDistributor), () -> new PowerDistributor());
    ...
    public static final DeferredHolder<Block, Redstone> REDSTONE =
            BLOCKS.register(key(Constants.BlockName.Redstone), () -> new Redstone());
    ...
    public static final DeferredHolder<Block, Rack> RACK =
            BLOCKS.register(key(Constants.BlockName.Rack), () -> new Rack());
    ...
    public static final DeferredHolder<Block, Microcontroller> MICROCONTROLLER =
            BLOCKS.register(key(Constants.BlockName.Microcontroller), () -> new Microcontroller());
    ...
    public static final DeferredHolder<Block, Printer> PRINTER =
            BLOCKS.register(key(Constants.BlockName.Printer), () -> new Printer());
    ...
    public static final DeferredHolder<Block, Waypoint> WAYPOINT =
            BLOCKS.register(key(Constants.BlockName.Waypoint), () -> new Waypoint());
    ...
    public static final DeferredHolder<Block, CarpetedCapacitor> CARPETED_CAPACITOR =
            BLOCKS.register(key(Constants.BlockName.CarpetedCapacitor), () -> new CarpetedCapacitor());
