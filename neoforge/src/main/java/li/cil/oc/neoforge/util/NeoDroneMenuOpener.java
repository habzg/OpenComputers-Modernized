...
public class NeoDroneMenuOpener implements DroneMenuDelegate {
    public static final NeoDroneMenuOpener INSTANCE = new NeoDroneMenuOpener();

    private NeoDroneMenuOpener() {
    }
    ...
    public void openMenu(Player player, Object droneObj) {
        ...
        player.openMenu(new net.minecraft.world.MenuProvider() {
            ...
            public net.minecraft.world.inventory.AbstractContainerMenu createMenu(int id, net.minecraft.world.entity.player.@NotNull Inventory inv, @NotNull Player player) {
                return new li.cil.oc.neoforge.common.container.Drone(id, inv, drone);
            }
